      ...
      <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50 to-orange-50 dark:from-stone-900 dark:via-amber-900 dark:to-orange-900">
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          {/* Call-to-Action Section */}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl mb-8">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-serif font-bold text-gray-900 dark:text-white mb-4">Your Style Analysis</h2>
                <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                  Based on your preferences, here's what we discovered about your style
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-green-50 dark:bg-green-900/20 rounded-2xl p-6">
                  ...
                  <ul className="space-y-2 text-green-700 dark:text-green-300">
                    <li>• You have a clear sense of personal style</li>
                    <li>• You know what works for your body type</li>
                    <li>• You're confident in your fashion choices</li>
                    <li>• You have a signature look that defines you</li>
                  </ul>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6">
                  ...
                  <ul className="space-y-2 text-blue-700 dark:text-blue-300">
                    <li>• Try mixing textures and patterns</li>
                    <li>• Experiment with statement accessories</li>
                    <li>• Add pops of color to your neutrals</li>
                    <li>• Layer different lengths and silhouettes</li>
                  </ul>
                </div>
              </div>
            </div>

            {/* Style Exploration Widget */}
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-8 text-white shadow-xl mb-8">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-serif font-bold mb-4">Ready to Branch Out?</h2>
                <p className="text-purple-100 text-lg max-w-2xl mx-auto">
                  Your {persona.name.toLowerCase()} style is solid, but there's always room to explore new possibilities
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Color Play</h3>
                  <p className="text-purple-100 text-sm mb-4">Try adding one bold color piece to your current wardrobe</p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
                  <div className="text-4xl mb-4">🔀</div>
                  <h3 className="text-xl font-semibold mb-2">Style Mixing</h3>
                  <p className="text-purple-100 text-sm mb-4">Combine different style elements for a fresh look</p>
                  <button className="bg-white/20 hover:bg-white/30 px-4 py-2 rounded-full text-sm font-medium transition-colors">
                    Mix & Match Guide
                  </button>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
                  ...
                  <p className="text-purple-100 text-sm mb-4">Elevate your look with the right accessories</p>
                  <button className="bg-white/20 hover:bg-white/30 px-4 py-2 rounded-full text-sm font-medium transition-colors">
                    Accessory Guide
                  </button>
                </div>
            ...
            {/* Wardrobe Gaps Widget */}
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl mb-8">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-serif font-bold text-gray-900 dark:text-white mb-4">Fill Your Style Gaps</h2>
                <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                  Complete your {persona.name.toLowerCase()} wardrobe with these essential pieces
                </p>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl">
                  <div className="text-3xl mb-3">👔</div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Statement Blazer</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">A versatile piece that elevates any outfit</p>
                </div>
                
                <div className="text-center p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl">
                  <div className="text-3xl mb-3">👖</div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Perfect Jeans</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">The foundation of casual chic</p>
                </div>
                
                <div className="text-center p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl">
                  <div className="text-3xl mb-3">👟</div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Signature Shoes</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Shoes that define your style</p>
                </div>
                
                <div className="text-center p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl">
                  <div className="text-3xl mb-3">👜</div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Go-To Bag</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">The perfect everyday companion</p>
                </div>
              </div>
            </div>
