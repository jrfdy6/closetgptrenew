...
export async function GET(request: Request) {
  try {
    ...
    const backendUrl = 'https://closetgpt-backend-production.up.railway.app'; // Force correct backend URL
...
async function handleOutfitHistory(request: Request) {
  try {
    ...
    const backendUrl = 'https://closetgpt-backend-production.up.railway.app';
