...
CHALLENGE_CATALOG = {
    ...
    "color_harmony": Challenge(
        ...
        description="Log 3 outfits using complementary colors",
        rules={
            "outfits_required": 3,
    ...
    "monochrome_week": Challenge(
        ...
        description="Log 3 monochrome outfits this week",
    ...
    "bold_colors": Challenge(
        ...
        type=ChallengeType.COLOR_EXPLORER,
        title="Bold Colors",
        description="Log 2 outfits with bold/vibrant colors",
    ...
    "neutral_master": Challenge(
        ...
        description="Log 4 outfits using only neutral colors",
    ...
    "pattern_master": Challenge(
        ...
        description="Log 3 outfits with pattern mixing",
    ...
    "solid_stylist": Challenge(
        ...
        type=ChallengeType.PATTERN_MASTER,
        title="Solid Stylist",
        description="Log 4 outfits using only solid colors (no patterns)",
    ...
    "texture_explorer": Challenge(
        ...
        description="Log 3 outfits mixing different textures",
    ...
    "complete_catalog": Challenge(
        ...
        description="Upload 8 different clothing types",
    ...
    "versatile_pro": Challenge(
        ...
        type=ChallengeType.CONTEXT,
        title="Versatile Pro",
        description="Log outfits for 5 different contexts",
