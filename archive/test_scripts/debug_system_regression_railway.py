#!/usr/bin/env python3
"""
Debug System Regression After Mood Fix - Railway

Test simple scenarios on Railway to understand why the system broke after fixing mood filtering.
"""

import sys
sys.path.append('backend/src')

def test_simple_scenario_railway():
    """Test a simple scenario that should work on Railway"""
    ...
    print("🔍 TESTING SIMPLE SCENARIO ON RAILWAY")
    print("=" * 60)
